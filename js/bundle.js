...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	    ...
	    $callForm.on('submit', function (e) {
	        ...
	        var phone = (0, _jquery2.default)('#phone').val().replace(/[^\d]/g, '');

	        if (phone.length < 10) {
	            (0, _jquery2.default)('#phone').focus();
	            return alert('Please enter your 10 digit phone number.');
	        }

	        _jquery2.default.getJSON(CALL_TOOL_URL, {
	    ...
	    // Special URLs
	    if ($callForm.length) {
	        if (_statickit2.default.query.after === 'signing-petition') {
	            (0, _jquery2.default)('body').addClass('coming-from-petition');
	        }

	        if (_statickit2.default.query.test === 'calling') {
	            showCallingScript();
	        }
	    }

	    var $feedbackForm = (0, _jquery2.default)('.calling-wrapper form');
	    ...
	    (0, _jquery2.default)('button.add-your-name').on('click', function (e) {
	        e.preventDefault();
	    ...
	    // Hashes
	    if (location.hash === '#sent' || _statickit2.default.query.sent) {
	    ...
	    function showCheckYourEmailPrompt() {
	        var $prompt = (0, _jquery2.default)('.check-your-email-prompt');
	    ...
	    function showCallingScript() {
	        (0, _jquery2.default)('body').addClass('calling');
	        document.body.offsetHeight; // Reflow
	        (0, _jquery2.default)('html, body').stop().animate({
	            scrollTop: (0, _jquery2.default)('.calling-wrapper').offset().top - 16
	        }, 640);
	    }
	});
